<template>
  ...
  >
    <v-card
      ...
      tile
      class="light darken-1 white--text text-center"
    >
      <v-card-text>
        <v-btn
      ...
      <v-card-text class="secondary--text text-darken-5 pt-0 px-12">
        <span class="primary--text">Match Maker</span> is a simple Memory Game built
